...
def build_report_content(
    *,
    ...
    lines: list[str] = [
        ...
        "`glitchlings._zoo_rust` across several representative pipeline configurations.\n\n",
        "## Benchmark setup\n\n",
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Scenario(s) to include in the report (defaults to all). Can be specified multiple times.",
    )
