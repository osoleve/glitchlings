    ...
    *,
    ...
    lines: list[str] = [
        ...
        (
            ...
            "It preserves the historical pure-Python benchmarks while documenting the "
            "Rust acceleration layer now required via `glitchlings._zoo_rust` across "
            "representative pipeline configurations and individual glitchlings with "
            "compiled fast paths.\n\n"
        ),
        "## Benchmark setup\n\n",
