...
def _load_gallery_resources() -> tuple[str, Mapping[str, GlitchlingType]]:
    """Return the default sample text and builtin glitchling registry."""
    if str(SRC_PATH) not in sys.path:
        sys.path.insert(0, str(SRC_PATH))

    from glitchlings import SAMPLE_TEXT as default_sample_text
    from glitchlings.zoo import BUILTIN_GLITCHLINGS

    return default_sample_text, BUILTIN_GLITCHLINGS
...
def build_gallery_content(
    *,
    ...
    default_sample_text, builtin_glitchlings = _load_gallery_resources()
